# В этом репозитории можно посмотреть мои решения алгоритмических заданий. В папке src/ в соответствующим каждой задаче файле находится описание таска и мое решение. #
